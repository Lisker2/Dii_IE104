...
@WebServlet("/tspdeleteServlet")
public class tspdeleteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        tspHisMapper.delete(email,time);
        sqlSession.commit();

        File fileToDelete = new File(tsp.solution_path);
